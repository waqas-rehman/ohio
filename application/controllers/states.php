	...
	public function insert_state($msg = 0)
	{
		if($_POST)
		{
			...
			if ($this->form_validation->run() == FALSE)
			{
				...
				$param1["state_name"] = mysql_real_escape_string($this->input->post("state_name")) ;
				$param1["state_code"] = mysql_real_escape_string($this->input->post("state_code")) ;
				$param1["state_status"] = mysql_real_escape_string($this->input->post("state_status")) ;
