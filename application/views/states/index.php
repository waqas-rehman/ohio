							...
							<tbody>
								...
								<tr>
									...
									<td align="center" valign="middle">
                                        ...
                                        &nbsp;&nbsp;
                                    	<a href="<?php echo base_url("states/remove_state/".encoded_string($recs->state_id, "&", 10)) ; ?>" class="item small" onclick="return confirm('Are you sure to remove this record?')">
