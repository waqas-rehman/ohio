...
<div id="right">
    ...
    <div class="section">
		...
		<div class="content">
			<form method="post" action="<?php echo base_url("questions/add_question") ; ?>">
				
                <div class="row height">
            		<label for="">Choose Question Type</label>
					<div class="right">
                    	<div class="custom-radio">
                       		<input type="radio" id="radio-1" name="question_type" value="type1" <?php if($question_type == "type1") echo set_radio('question_type', 'type1', true) ; else set_radio('question_type', 'type1') ; ?>  />
                       		<label for="radio-1"><img src="<?php echo base_url("images/type1.png") ; ?>" class="question_type"  /></label>
                        </div>
                        <div class="custom-radio">
                			<input type="radio" id="radio-2" name="question_type" value="type2" <?php if($question_type == "type2") echo set_radio('question_type', 'type2', true) ; else set_radio('question_type', 'type2') ; ?> />
                      		<label for="radio-2"><img src="<?php echo base_url("images/type2.png") ; ?>" class="question_type" /></label>
               			</div>
                        <div class="custom-radio">
                			<input type="radio" id="radio-3" name="question_type" value="type3" <?php if($question_type == "type3") echo set_radio('question_type', 'type3', true) ; else set_radio('question_type', 'type3') ; ?> />
                       		<label for="radio-3"><img src="<?php echo base_url("images/type3.png") ; ?>" class="question_type" /></label>
                		</div>
                        <div class="custom-radio">
                			<input type="radio" id="radio-4" name="question_type" value="type4" <?php if($question_type == "type4") echo set_radio('question_type', 'type4', true) ; else set_radio('question_type', 'type4') ; ?> />
                ...
                <div class="row height">
					...
					<div class="right">
                    	<div class="custom-radio">
                			<input type="radio" id="radio-5" name="question_type" value="type5" <?php if($question_type == "type5") echo set_radio('question_type', 'type5', true) ; else set_radio('question_type', 'type5') ; ?> />
                      		<label for="radio-5"><img src="<?php echo base_url("images/type5.png") ; ?>" class="question_type" /></label>
                        </div>
                        <div class="custom-radio">
                			<input type="radio" id="radio-6" name="question_type" value="type6" <?php if($question_type == "type6") echo set_radio('question_type', 'type6', true) ; else set_radio('question_type', 'type6') ; ?> />
                     		<label for="radio-6"><img src="<?php echo base_url("images/type6.png") ; ?>" class="question_type" /></label>
                      	</div>
                        <div class="custom-radio">
                			<input type="radio" id="radio-7" name="question_type" value="type7" <?php if($question_type == "type7") echo set_radio('question_type', 'type7', true) ; else set_radio('question_type', 'type7') ; ?> />
                ...
                <div class="row">
                    ...
                    <div class="right"><input type="text" name="number_of_choices" value="<?php if($number_of_choices == 0) echo set_value('number_of_choices') ; else   echo set_value('number_of_choices', $number_of_choices) ;?>" /></div>
                </div>
                ...
                <div class="row">
					...
					<div class="right">
                    	<div class="custom-radio">
                        	<input type="radio" id="radio-11" name="answer_type" value="single_answer" <?php if($answer_type == "single_answer") echo set_radio('answer_type', 'single_answer', true) ; else echo set_radio('answer_type', 'single_answer') ; ?> />
                            <label for="radio-11">Single Answer Question (Radio Buttons)</label>
                        </div>
                    </div>
                    <div class="right">
                    	<div class="custom-radio">
                        	<input type="radio" id="radio-12" name="answer_type" value="multiple_answer" <?php if($answer_type == "multiple_answer") echo set_radio('answer_type', 'multiple_answer', true) ; else echo set_radio('answer_type', 'multiple_answer') ; ?> />
