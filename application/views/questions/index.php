							...
							<tbody>
								...
								<tr>
									...
									?>
                              		...
                              		<td align="center" valign="middle"><?php echo $recs->number_of_choices ; ?></td>
                                    <td align="center" valign="middle"><?php if($recs->answer_type == "single_answer") echo "Single Answer" ; else echo "Multiple Answers" ; ?></td>
									<td align="center" valign="middle">
                                    	<a href="<?php echo base_url("questions/preview_question/".encoded_string($recs->question_id, "&", 10)) ; ?>" class="item small" target="_new">
                                        	<img title="Preview Question" src="<?php echo base_url("gfx/icons/small/file.png") ; ?>" alt="Question" />
                                        </a>&nbsp;&nbsp;
                                        <a href="<?php echo base_url("questions/edit_question/".encoded_string($recs->question_id, "&", 10)) ; ?>" class="item small">
                                        	<img title="Edit Record" src="<?php echo base_url("gfx/icons/small/edit.png") ; ?>" alt="Edit" />
                                        </a>&nbsp;&nbsp;
                                    	<a href="<?php echo base_url("questions/remove_question/".encoded_string($recs->question_id, "&", 10)) ; ?>" class="item small" onclick="return confirm('Are you sure to remove this record?')">
